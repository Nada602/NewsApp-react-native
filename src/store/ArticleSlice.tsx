...
export const getarticles = createAsyncThunk<NewsApiResponse, void>(
...
export const searchArticle = createAsyncThunk<NewsApiResponse, String>(
...
export const filterArticle = createAsyncThunk<NewsApiResponse, string>(
  "articles/filterarticles",
  async (filterQuery, thunkAPI) => {
    const { rejectWithValue } = thunkAPI;
    try {
      const response = await api.get<NewsApiResponse>("/everything", {
        params: {
